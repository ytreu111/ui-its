...
var uiItsIcons = require('ui-its-icons');
var d3 = require('d3');
...
const opacityColor$1 = (color, val) => `
    ${d3__namespace.rgb(color).copy({ opacity: val })}
`;
...
`;
const LoadingIconWrap$1 = styled__default["default"].div `
  position: absolute;
`;
const TextWrap$1 = styled__default["default"].div ``;
...
`;
styled__default["default"](StyledButton$1) `
 background: transparent;
`;
const PrimaryButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const DangerButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const OrangeButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const YellowButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const GreenButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const PurpleButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const MagentaButton$1 = styled__default["default"](StyledButton$1) `
...
`;
const BlueButton$1 = styled__default["default"](StyledButton$1) `
...
const resolveButton = (props, type) => {
    switch (type) {
        case ButtonTypeEnum.primary: {
            return jsxRuntime.jsx(PrimaryButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.danger: {
            return jsxRuntime.jsx(DangerButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.orange: {
            return jsxRuntime.jsx(OrangeButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.yellow: {
            return jsxRuntime.jsx(YellowButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.green: {
            return jsxRuntime.jsx(GreenButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.purple: {
            return jsxRuntime.jsx(PurpleButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.magenta: {
            return jsxRuntime.jsx(MagentaButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.blue: {
            return jsxRuntime.jsx(BlueButton, Object.assign({}, props), void 0);
        }
        case ButtonTypeEnum.transparent: {
            return jsxRuntime.jsx(BlueButton, Object.assign({}, props), void 0);
        }
        default:
            return jsxRuntime.jsx(StyledButton, Object.assign({}, props), void 0);
    }
};
const Button = (_a) => {
    ...
    const onClickEffect = react.useCallback((event) => {
    ...
    const onClickEvent = react.useCallback((e) => {
        if (!loading) {
            if (clickEffect)
                onClickEffect(e);
            if (onClick)
    ...
    const content = react.useMemo(() => {
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [icon, jsxRuntime.jsx(TextWrap, { children: children }, void 0), loading && jsxRuntime.jsx(LoadingIconWrap, { children: jsxRuntime.jsx(uiItsIcons.LoadingIcon, {}, void 0) }, void 0)] }, void 0));
    }, [icon, children, loading]);
    const buttonProps = Object.assign(Object.assign({}, props), { className, children: content, onClick: onClickEvent });
    return (jsxRuntime.jsx(styled.ThemeProvider, Object.assign({ theme: theme }, { children: resolveButton(buttonProps, type) }), void 0));
};

const StyledInputContainer$1 = styled__default["default"].div `
  display: flex;
...
`;
const StyledInputLabel$1 = styled__default["default"].span `
  margin-top: 4px;
  font-weight: 600;
  font-size: 13px;
  line-height: 140%;
  color: #6A7B9B;
`;
const StyledInputEditablePlaceholder$1 = styled__default["default"].span `
  color: #6A7B9B;
  font-size: 14px;
  font-weight: 600;
  line-height: 140%;
  ...
  overflow: hidden;
`;
const OptionalInput$1 = styled__default["default"](Button) `
  position: absolute;
  height: 20px;
  top: 50%;
  ...
  right: 18px;
`;
const StyledInputWrap$1 = styled__default["default"].div `
  overflow: hidden;
  position: relative;
  height: 56px;
  width: 100%;
...
const Input = ({ value = '', disabled, small, placeholder, editableHelp = 'Введите данные', label, icon, error, autoWidth, onChange, onBlur, onFocus, name, width, optional, optionalIcon, }) => {
    const [visiblePlaceholder, setVisiblePlaceholder] = react.useState(false);
    const [inputValue, setInputValue] = react.useState(value);
    react.useEffect(() => setInputValue(value !== null && value !== void 0 ? value : undefined), [value]);
    const placeholderText = react.useMemo(() => (visiblePlaceholder ? editableHelp : placeholder), [editableHelp, placeholder, visiblePlaceholder]);
    const classNameWrap = react.useMemo(() => {
        const className = [];
        if (small)
    ...
    const optionalButton = react.useMemo(() => {
        const icon = optionalIcon ? optionalIcon : jsxRuntime.jsx(uiItsIcons.StarIcon, {}, void 0);
        const iconColor = error ? theme.colors.red_500 : theme.colors.blue_500;
        return (jsxRuntime.jsx(OptionalInput, { p: 0, iconMargin: 0, icon: icon, type: 'transparent', iconColor: iconColor, onClick: optional }, void 0));
    ...
    return (jsxRuntime.jsxs(StyledInputContainer, { children: [jsxRuntime.jsxs(StyledInputWrap, Object.assign({ className: classNameWrap, width: width }, { children: [!small && jsxRuntime.jsx(StyledInputEditablePlaceholder, { children: placeholder }, void 0), jsxRuntime.jsx(antd.Input, { onFocus: onFocusInput, onBlur: onBlurInput, disabled: disabled, prefix: icon, value: inputValue, placeholder: placeholderText, onChange: onChangeInput, name: name }, void 0), optional && optionalButton] }), void 0), label && jsxRuntime.jsx(StyledInputLabel, { children: label }, void 0)] }, void 0));
};
