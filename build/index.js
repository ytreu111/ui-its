...
`,b={StyledInputContainer:h,StyledInputLabel:g,StyledInputWrap:d.default.div`
  overflow: hidden;
  position: relative;
  height: 56px;
  width: 100%;
...
`,StyledInputEditablePlaceholder:x},{StyledInputContainer:_,StyledInputWrap:f,StyledInputEditablePlaceholder:y,StyledInputLabel:m}=b;exports.Input=({value:e='',disabled:n,small:l,placeholder:i,editableHelp:p='Введите данные',label:d,icon:u,error:c,allowClear:h,autoWidth:g,onChange:x,onBlur:b,onFocus:B,name:F})=>{const[v,w]=r.useState(!1),[$,C]=r.useState(e),S=r.useMemo((()=>!(!h||!$||n)),[h,n,$]),j=r.useMemo((()=>v?p:i),[p,i,v]),E=r.useMemo((()=>{const e=[];return l&&e.push('small'),g&&e.push('auto'),u&&e.push('icon'),v&&e.push('focus'),(v||$)&&e.push('placeholder_top'),c&&e.push('error'),S&&e.push('clear'),n&&e.push('disabled'),e.join(' ')}),[g,n,c,u,$,S,l,v]),z=r.useCallback((()=>{w(!0),B&&B()}),[B]),A=r.useCallback((()=>{w(!1),b&&b()}),[b]),D=r.useCallback((e=>{C(e.currentTarget.value),x&&x(e.currentTarget.value)}),[x]);return t.jsx(a.ThemeProvider,Object.assign({theme:s},{children:t.jsxs(_,{children:[t.jsxs(f,Object.assign({className:E},{children:[!l&&t.jsx(y,{children:i},void 0),t.jsx(o.Input,{onFocus:z,onBlur:A,disabled:n,prefix:u,value:$,placeholder:j,onChange:D,name:F},void 0)]}),void 0),d&&t.jsx(m,{children:d},void 0)]},void 0)}),void 0)},exports.styleMixins=u,exports.theme=s;
